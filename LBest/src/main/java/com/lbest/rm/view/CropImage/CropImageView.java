...
public class CropImageView extends FrameLayout {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mBitmap != null) {
            final Rect bitmapRect = CropImageViewUtil.getBitmapRectCenterInside(mBitmap, this);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mBitmap != null) {
            ...
            final Rect bitmapRect = CropImageViewUtil.getBitmapRectCenterInside(mBitmap.getWidth(),
                    mBitmap.getHeight(),
                    mLayoutWidth,
                    mLayoutHeight);
            mCropOverlayView.setBitmapRect(bitmapRect);
    ...
    public Bitmap getCroppedImage() {
        ...
        final Rect displayedImageRect = CropImageViewUtil.getBitmapRectCenterInside(mBitmap, mImageView);
