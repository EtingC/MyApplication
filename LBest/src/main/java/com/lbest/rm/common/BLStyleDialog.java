...
public class BLStyleDialog {
    ...
    private static OnBLDialogBtnListener mOnConfimBtnListener, mOnCancelBtnListener;
    ...
    private void initView(){
        ...
        mDialogLayout = (LinearLayout) inflater.inflate(R.layout.bl_custom_alert_layout, null);
